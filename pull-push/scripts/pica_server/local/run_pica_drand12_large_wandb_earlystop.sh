...
RUN_NAME=${RUN_NAME:-hand_drag_gla_45936_pica_drand12_aux_v2c_large_es}
GPU=${GPU:-5}
MAX_EPOCHS=${MAX_EPOCHS:-300}
NUM_ENVS=${NUM_ENVS:-64}
TRAIN_CFG=${TRAIN_CFG:-ppo/train_config_gla_pica_drand12_aux_v2c.yaml}
OBJECT_ID=${OBJECT_ID:-45936}
BOUNDS_LOSS_COEF=${BOUNDS_LOSS_COEF:-0.01}
SAVE_EVERY=${SAVE_EVERY:-25}
EARLY_MIN_EPOCHS=${EARLY_MIN_EPOCHS:-150}
...
SAVE_EPOCHS=$(seq ${SAVE_EVERY} ${SAVE_EVERY} ${MAX_EPOCHS} | paste -sd, -)
export PICA_SAVE_EPOCHS=${PICA_SAVE_EPOCHS:-${SAVE_EPOCHS}}
...
PICA_SAVE_EPOCHS=${PICA_SAVE_EPOCHS}
